...
app.post('/search', (req, res) => {
    ...
    let movieUrl = `https://api.themoviedb.org/3/search/movie?api_key=36fc0016d3d04b3cc6f69a16bed51388&query=${userMovieTitle}`;
    let genresUrl = 'https://api.themoviedb.org/3/genre/movie/list?api_key=36fc0016d3d04b3cc6f69a16bed51388&language=en-US';
